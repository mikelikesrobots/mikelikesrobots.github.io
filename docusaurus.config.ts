    ...
    navbar: {
      ...
      items: [
        ...
        {to: '/blog', label: 'Blog', position: 'left'},
        {
          ...
          // label: 'AWS Community',
          position: 'right',
          className: 'header-aws-community-link header-link',
        },
        {
          href: 'https://www.youtube.com/channel/UCAdis20vFM97syzwG1YlacQ',
          // label: 'YouTube',
          position: 'right',
          className: 'header-youtube-link header-link',
        },
        {
        ...
        // <a href="https://github.com/mikelikesrobots" target="_blank" rel="noopener noreferrer">GitHub</a>
        {
          href: 'https://github.com/mikelikesrobots',
          // label: 'GitHub',
          'aria-label': 'GitHub',
          html: '<i class="fa fa-github fa-lg"></i>GitHub',
          position: 'right',
